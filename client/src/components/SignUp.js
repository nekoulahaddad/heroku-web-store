  ...
  onChangePass = (e) => {
    ...
    if (
      ...
      document
        ...
        .classList.remove("disabledContent");
    } else
      document
        .getElementById("sign_up_button")
        .classList.add("disabledContent");
    this.setState({
          ...
          {!this.props.isAuthenticated ? (
              ...
              <Row>
                <Col className="align-self-center" md={6}>
                  <Form className="navor" onSubmit={this.onSubmit}>
                    ...
                    <Button
                      id="sign_up_button"
                      className="mr-3 disabledContent"
                    >
                      Submit
                    </Button>
                  </Form>
                  <div id="message" className="mt-3">
                    ...
                    <p id="letter" className="invalid ml-5">
                      A <b>lowercase</b> letter
                    </p>
                    <p id="capital" className="invalid ml-5">
                      A <b>capital (uppercase)</b> letter
                    </p>
                    <p id="number" className="invalid ml-5">
                      A <b>number</b>
                    </p>
                    <p id="length" className="invalid ml-5">
            ...
            <div className="mt-3">
              <UncontrolledAlert color="info">
                welcome {this.props.user.name} .... you are a member now
              </UncontrolledAlert>
            </div>
          )}
        </div>
