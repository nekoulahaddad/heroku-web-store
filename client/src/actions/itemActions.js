...
export const addItem = (item) => (dispatch, getState) => {
  axios
    .post("/items/uploadProduct", item, tokenConfig(getState))
...
export const getItem = (id) => (dispatch, getState) => {
  dispatch({ type: ITEMS_LOADING });
  axios
    .get(`/items/${id}`, tokenConfig(getState))
    .then((res) =>
      dispatch({
        type: GET_ITEM,
        payload: res.data,
...
export const addComment = (id, { content }) => (dispatch, getState) => {
  ...
  axios
    .post(`/items/${id}/addComment`, body, tokenConfig(getState))
    .then((res) =>
      dispatch({
        type: ADD_COMMENT,
        payload: res.data,
...
export const addReply = (id, _id, { Reply_content }) => (
  dispatch,
  getState
) => {
  ...
  axios
    .post(`/items/addReply/${id}?CommentId=${_id}`, body, tokenConfig(getState))
    .then((res) =>
      dispatch({
        type: ADD_REPLY,
        payload: res.data,
